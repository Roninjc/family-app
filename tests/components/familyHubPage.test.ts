...
import FamilyHubPage from '../../src/routes/family/[familyId]/hub/+page.svelte'
...
describe('family hub page', () => {
  ...
  it('shows empty fallback when there is no active family', async () => {
    ...
    expect(document.querySelector('.family-hub-empty h2')?.textContent).toContain(
