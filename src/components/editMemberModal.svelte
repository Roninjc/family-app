      ...
      {#if activeSection === 'datos'}
        <div in:fade={{ duration: 140 }}>
          <form
            method="POST"
            action="?/updateMember"
            use:enhance={enhanceMemberForm}
            class="edit-data-form modal-form"
          >
      ...
      {#if editable && activeSection === 'ajustes'}
        <div class="settings-section" in:fade={{ duration: 140 }}>
          <div class="settings-actions">
            ...
            <a
              class="app-btn app-btn--secondary invite-member-button"
              href={`/admin?memberId=${member.id}`}
            >
              Invitar por email
            </a>
          </div>
...
<style lang="scss">
  .edit-member-modal {
    --edit-avatar-text: #6d4f3a;
    --edit-tab-active-bg: rgba(149, 121, 95, 0.14);
    --edit-tab-active-text: #7e4520;
    --edit-viewer-note-bg: rgba(255, 247, 236, 0.76);
    --edit-primary-btn-bg: #dac7b1;
    --edit-primary-btn-bg-hover: #e0cfba;
    --edit-primary-btn-text: #4a392c;
    --edit-submit-btn-bg: #d8dece;
    --edit-submit-btn-bg-hover: #dfe6d5;
    --edit-submit-btn-text: #4d5a43;
    --edit-submit-btn-shadow: 5px 5px 12px rgba(124, 137, 108, 0.2),
      -5px -5px 12px rgba(250, 254, 246, 0.82);
    --edit-submit-btn-shadow-hover: 7px 7px 14px rgba(124, 137, 108, 0.24),
      -6px -6px 14px rgba(252, 255, 250, 0.86);
    --edit-settings-panel-bg: rgba(250, 244, 233, 0.65);
    --edit-settings-panel-border: rgba(149, 121, 95, 0.2);
    --edit-settings-title: #5f4632;
    --edit-invite-btn-bg: #f1e7da;
    --edit-invite-btn-bg-hover: #f6ede2;
    --edit-invite-btn-text: #6f4b31;
    --edit-invite-btn-shadow: 5px 5px 12px rgba(149, 121, 95, 0.13),
      -5px -5px 12px rgba(255, 255, 255, 0.68);
    --edit-invite-btn-shadow-hover: 7px 7px 14px rgba(149, 121, 95, 0.15),
      -6px -6px 14px rgba(255, 255, 255, 0.75);
    --edit-danger-zone-border: rgba(208, 124, 124, 0.45);
    --edit-danger-zone-bg: rgba(255, 237, 237, 0.55);
    --edit-danger-title: #8c2d2d;
    --edit-danger-copy: #7f1d1d;
    --edit-danger-button-text: #6e2424;
    --edit-danger-normal-bg: #f0dbd6;
    --edit-danger-normal-bg-hover: #f4e2dd;
    --edit-danger-normal-shadow: 5px 5px 12px rgba(140, 88, 88, 0.2),
      -5px -5px 12px rgba(255, 251, 251, 0.68);
    --edit-danger-normal-shadow-hover: 7px 7px 14px rgba(140, 88, 88, 0.23),
      -6px -6px 14px rgba(255, 253, 253, 0.78);
    --edit-danger-normal-shadow-active: inset 4px 4px 8px rgba(140, 88, 88, 0.2),
      inset -4px -4px 8px rgba(255, 251, 251, 0.58);
    --edit-danger-featured-bg: linear-gradient(145deg, #efe1de, #dcc3bd);
    --edit-danger-featured-border: #f0e2de;
    --edit-danger-featured-shadow: 6px 6px 14px rgba(140, 88, 88, 0.26),
      -6px -6px 14px rgba(255, 252, 252, 0.75), inset 5px 4px 6px rgba(132, 84, 84, 0.09),
      inset -4px -3px 7px rgba(255, 250, 250, 0.34);
    --edit-danger-featured-shadow-hover: 8px 8px 16px rgba(140, 88, 88, 0.28),
      -7px -7px 16px rgba(255, 253, 253, 0.8), inset 5px 4px 6px rgba(132, 84, 84, 0.09),
      inset -4px -3px 7px rgba(255, 250, 250, 0.34);
    --edit-danger-featured-shadow-active: 4px 4px 10px rgba(140, 88, 88, 0.2),
      -4px -4px 10px rgba(255, 252, 252, 0.68), inset 7px 6px 10px rgba(132, 84, 84, 0.16),
      inset -6px -5px 10px rgba(255, 251, 251, 0.46);
    --edit-danger-cancel-text: #4f4a45;
    --edit-danger-cancel-bg: linear-gradient(145deg, #f1ede7, #ddd6cc);
    --edit-danger-cancel-border: #ece5da;
    --edit-danger-cancel-shadow: 6px 6px 14px rgba(141, 130, 113, 0.2),
      -6px -6px 14px rgba(255, 255, 255, 0.8), inset 5px 4px 6px rgba(148, 136, 118, 0.08),
      inset -4px -3px 7px rgba(255, 255, 255, 0.34);
    --edit-danger-cancel-shadow-hover: 8px 8px 16px rgba(141, 130, 113, 0.24),
      -7px -7px 16px rgba(255, 255, 255, 0.84), inset 5px 4px 6px rgba(148, 136, 118, 0.08),
      inset -4px -3px 7px rgba(255, 255, 255, 0.34);
    --edit-danger-cancel-shadow-active: 4px 4px 10px rgba(141, 130, 113, 0.18),
      -4px -4px 10px rgba(255, 255, 255, 0.76), inset 7px 6px 10px rgba(148, 136, 118, 0.14),
      inset -6px -5px 10px rgba(255, 255, 255, 0.44);
    --edit-avatar-shadow: inset 3px 3px 7px rgba(154, 132, 109, 0.18),
    ...
    .member-avatar {
      ...
      font-size: 0.84rem;
      font-weight: 800;
      color: var(--edit-avatar-text);
      background: var(--surface-avatar);
      box-shadow: var(--edit-avatar-shadow);
    ...
    .section-tabs {
      ...
      button {
        ...
        transition:
          ...
          border-color var(--dur-base) var(--motion-standard),
        ...
        &.active {
          background: var(--edit-tab-active-bg);
          color: var(--edit-tab-active-text);
    ...
    .viewer-note {
      ...
      padding: 8px 10px;
      border-radius: var(--radius-control);
      background: var(--edit-viewer-note-bg);
    ...
    button:not(.app-settings-trigger) {
      ...
      min-height: 42px;
      padding: 10px;
      background: var(--edit-primary-btn-bg);
      color: var(--edit-primary-btn-text);
      border: none;
      border-radius: var(--radius-control);
      cursor: pointer;
      transition:
      ...
      &:hover {
        background: var(--edit-primary-btn-bg-hover);
        transform: translateY(-1px);
        box-shadow: var(--neu-shadow-out-soft);
      }

      &[type='submit'] {
        background: var(--edit-submit-btn-bg);
        color: var(--edit-submit-btn-text);
        box-shadow: var(--edit-submit-btn-shadow);

        &:hover {
          background: var(--edit-submit-btn-bg-hover);
          transform: translateY(-1px);
          box-shadow: var(--edit-submit-btn-shadow-hover);
        }
    ...
    .settings-actions {
      ...
      background: var(--edit-settings-panel-bg);
      border: 1px solid var(--edit-settings-panel-border);

      h3 {
        margin: 0 0 0.35rem;
        font-size: var(--fs-md);
        color: var(--edit-settings-title);
      }
    ...
    .invite-member-button {
      ...
      border-radius: var(--radius-control);
      font-size: var(--fs-xs);
      background: var(--edit-invite-btn-bg);
      border: none;
      color: var(--edit-invite-btn-text);
      box-shadow: var(--edit-invite-btn-shadow);

      &:hover {
        background: var(--edit-invite-btn-bg-hover);
        box-shadow: var(--edit-invite-btn-shadow-hover);
      }
    }
    ...
    .danger-zone {
      ...
      padding: 0.8rem;
      border-radius: var(--radius-md);
      border: 1px solid var(--edit-danger-zone-border);
      background: var(--edit-danger-zone-bg);
      display: flex;
      flex-direction: column;
      gap: 0.5rem;
      ...
      button.delete-button {
        color: var(--edit-danger-button-text);
      }

      button.delete-button--normal {
        background: var(--edit-danger-normal-bg);
        box-shadow: var(--edit-danger-normal-shadow);

        &:hover {
          background: var(--edit-danger-normal-bg-hover);
          transform: translateY(-1px);
          box-shadow: var(--edit-danger-normal-shadow-hover);
        }

        &:active {
          transform: translateY(0);
          box-shadow: var(--edit-danger-normal-shadow-active);
        }
      }

      button.delete-button--featured {
        background: var(--edit-danger-featured-bg);
        border: 3px solid var(--edit-danger-featured-border);
        box-shadow: var(--edit-danger-featured-shadow);

        &:hover {
          transform: translateY(-1px);
          box-shadow: var(--edit-danger-featured-shadow-hover);
        }

        &:active {
          transform: translateY(0);
          box-shadow: var(--edit-danger-featured-shadow-active);
        }
      }

      button.delete-button--cancel {
        color: var(--edit-danger-cancel-text);
        background: var(--edit-danger-cancel-bg);
        border-color: var(--edit-danger-cancel-border);
        box-shadow: var(--edit-danger-cancel-shadow);

        &:hover {
          box-shadow: var(--edit-danger-cancel-shadow-hover);
        }

        &:active {
          box-shadow: var(--edit-danger-cancel-shadow-active);
        }
      }
    }
