import type { FamilyData } from '../types/familyTypes'

// Original hardcoded family data. Used as in-app fallback seed and as the
// source for scripts/migrate-seed.ts. Keep this module free of $app imports
// so it can be executed outside SvelteKit (tsx/node).
